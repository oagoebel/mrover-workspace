...
def servo_callback(channel, msg):
    ...
    if servo.id == "servo_1":
        ...
        run_servo(servos[2], servo.degrees)
    elif servo.id == "servo_4":
        run_servo(servos[3], servo.degrees)
    elif servo.id == "servo_5":
        run_servo(servos[4], servo.degrees)
    elif servo.id == "servo_6":
        run_servo(servos[5], servo.degrees)
    else:
